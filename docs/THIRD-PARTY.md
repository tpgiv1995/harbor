...
repository was a licensing conflict, not a housekeeping choice. The Herdr
backend itself was retired on 2026-08-14 and the whole integration, including
`docs/UPSTREAM-HERDR.md` (the pointer that used to sit here), was removed
with it.
