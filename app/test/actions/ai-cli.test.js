...
function parse(...argv) {
  return spawnSync(process.execPath, [AI, ...argv], {
    encoding: 'utf8',
    env: {
      ...process.env,
      ELECTRON_RUN_AS_NODE: '1',
      HARBOR_AI_DRY_RUN: '1',
      HARBOR_CONFIG_FILE: path.join(os.tmpdir(), 'harbor-ai-cli-missing-config.json'),
      HARBOR_CLAUDE_BIN: 'claude',
      HARBOR_CODEX_BIN: 'codex',
      HARBOR_CURSOR_BIN: 'cursor-agent',
    },
  });
}
