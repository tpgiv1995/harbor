...
const SCHEMA = Object.freeze({
  ...
  // notesFile follows tasksFile: null by default, resolved against the Electron
  // userData directory at use.
  // boardsDir is null by default and resolves to <userData>/boards at use.
  paths: {
    projectsDir: null,
    cacheDir: null,
