...
Install the USB and build dependencies. These are the Linux instructions (package names shown for Debian/Ubuntu); a Windows equivalent of this toolchain is unproven.
